 ...
 */
class WP_BootstrapSidebar_Navwalker extends Walker_Nav_Menu
{
    /**
    ...
    public function start_lvl(&$output, $depth = 0, $args = array())
    {
        ...
        $output .= "\n$indent<ul class=\" sidebar-menu\" role=\"menu\">\n";
    }
    ...
    public function start_el(&$output, $item, $depth = 0, $args = array(), $id = 0)
    {
        ...
        if (strcasecmp($item->attr_title, 'divider') == 0 && $depth === 1) {
            ...
            $classes[]   = ' waves-effect waves-orange';
            ...
            */
            ...
            if ($args->has_children && $depth === 0) {
                $atts['href']        = '#';
                $atts['data-toggle'] = 'sidebar-dropdown';
                $atts['class']       = 'sidebar-menu-button';
            } else {
